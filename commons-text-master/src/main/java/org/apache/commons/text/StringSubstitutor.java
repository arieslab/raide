...
public class StringSubstitutor {
    ...
    private StringSubstitutorProduct stringSubstitutorProduct = new StringSubstitutorProduct();
    ...
    public StringSubstitutor(final StringLookup variableResolver, final String prefix, final String suffix,
        ...
        stringSubstitutorProduct.setVariablePrefix(prefix, this);
        stringSubstitutorProduct.setVariableSuffix(suffix, this);
        this.setEscapeChar(escape);
        stringSubstitutorProduct.setValueDelimiterMatcher(DEFAULT_VALUE_DELIMITER, this);
    }
    ...
    public StringSubstitutor(final StringLookup variableResolver, final String prefix, final String suffix,
        ...
        stringSubstitutorProduct.setVariableSuffix(suffix, this);
        this.setEscapeChar(escape);
        stringSubstitutorProduct.setValueDelimiter(valueDelimiter, this);
    }
    ...
    public StringSubstitutor(final StringLookup variableResolver, final StringMatcher prefixMatcher,
        ...
        this.setVariableResolver(variableResolver);
        stringSubstitutorProduct.setVariablePrefixMatcher(prefixMatcher, this);
        stringSubstitutorProduct.setVariableSuffixMatcher(suffixMatcher, this);
        this.setEscapeChar(escape);
        stringSubstitutorProduct.setValueDelimiterMatcher(valueDelimiterMatcher, this);
    }
    ...
    public StringMatcher getValueDelimiterMatcher() {
        return stringSubstitutorProduct.getValueDelimiterMatcher();
    }
    ...
    public StringMatcher getVariablePrefixMatcher() {
        return stringSubstitutorProduct.getPrefixMatcher();
    }
    ...
    public StringMatcher getVariableSuffixMatcher() {
        return stringSubstitutorProduct.getSuffixMatcher();
    }
    ...
    public StringSubstitutor setValueDelimiter(final char valueDelimiter) {
        return stringSubstitutorProduct.setValueDelimiterMatcher(StringMatcherFactory.INSTANCE.charMatcher(valueDelimiter), this);
    }
    ...
    public StringSubstitutor setValueDelimiter(final String valueDelimiter) {
        return stringSubstitutorProduct.setValueDelimiter(valueDelimiter, this);
    }
    ...
    public StringSubstitutor setValueDelimiterMatcher(final StringMatcher valueDelimiterMatcher) {
        return stringSubstitutorProduct.setValueDelimiterMatcher(valueDelimiterMatcher, this);
    }
    ...
    public StringSubstitutor setVariablePrefix(final char prefix) {
        return stringSubstitutorProduct.setVariablePrefixMatcher(StringMatcherFactory.INSTANCE.charMatcher(prefix), this);
    }
    ...
    public StringSubstitutor setVariablePrefix(final String prefix) {
        return stringSubstitutorProduct.setVariablePrefix(prefix, this);
    }
    ...
    public StringSubstitutor setVariablePrefixMatcher(final StringMatcher prefixMatcher) {
        return stringSubstitutorProduct.setVariablePrefixMatcher(prefixMatcher, this);
    }
    ...
    public StringSubstitutor setVariableSuffix(final char suffix) {
        return stringSubstitutorProduct.setVariableSuffixMatcher(StringMatcherFactory.INSTANCE.charMatcher(suffix), this);
    }
    ...
    public StringSubstitutor setVariableSuffix(final String suffix) {
        return stringSubstitutorProduct.setVariableSuffix(suffix, this);
    }
    ...
    public StringSubstitutor setVariableSuffixMatcher(final StringMatcher suffixMatcher) {
        return stringSubstitutorProduct.setVariableSuffixMatcher(suffixMatcher, this);
    }
